# Architecture Review — Floreren Plant APP
...
## 4. Add derived state and coordinated actions to `useFloreren`

**Files:** `frontend/src/store/useFloreren.ts` (179 lines), every page component
