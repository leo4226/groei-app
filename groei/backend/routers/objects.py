...
async def update_object(object_id: int, data: ObjectUpdate):
    async with get_db() as db:
...
async def update_object_position(object_id: int, data: ObjectPositionUpdate):
    async with get_db() as db:
...
async def archive_object(object_id: int):
    async with get_db() as db:
