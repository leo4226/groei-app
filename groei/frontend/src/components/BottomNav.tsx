  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-surface/95 backdrop-blur-md border-t border-border flex justify-around items-end h-16 pb-[env(safe-area-inset-bottom)] z-50">
      ...
      <button
        ...
        className="flex flex-col items-center justify-center gap-0.5 px-3 pt-2 pb-1 text-[10px] transition-colors min-w-[64px] text-primary"
      >
        <div className="w-10 h-10 -mt-4 rounded-full bg-primary text-white flex items-center justify-center">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
            <line x1="12" y1="5" x2="12" y2="19" />
            <line x1="5" y1="12" x2="19" y2="12" />
          </svg>
        </div>
        <span className="-mt-1">{t.nav.add}</span>
      </button>
    </nav>
  )
}
