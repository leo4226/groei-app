    ...
    <div className={`card p-4 border-l-4 ${borderColor} flex items-center gap-3`}>
      ...
      {variant !== 'upcoming' && (
        <button
          ...
          className="bg-primary text-white px-4 py-2.5 rounded-xl font-semibold text-sm active:scale-95 transition-transform whitespace-nowrap flex-shrink-0 shadow-sm"
        >
          Done ✓
        </button>
      )}
