 ...
 */
export default function HouseholdPanel({ initialName, onMembersChange, onHouseholdNameChange }: Props) {
  const t = useT()
        ...
        <div className="space-y-2">
          ...
          {members.map((member) => (
            ...
            >
              ...
              {/* You cannot remove yourself, and an account with no legacy
                  users row has no id the delete endpoint would accept. */}
              {!member.is_self && member.user_id != null && (
                <button
