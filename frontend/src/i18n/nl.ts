...
export const nl: Translations = {
  ...
  settings: {
    ...
    display: 'Weergave',
    groupOutdoorWarnings: 'Groepeer tuinzorg in de kalender',
    groupOutdoorWarningsDesc: 'Bundel geselecteerde zorgmomenten per tuin, voor iedereen in je huishouden',
    calendarGroupingCareTypes: 'Zorgtypes bundelen',
    calendarGroupingMaps: 'Tuinen bundelen',
