...
export const nl: Translations = {
  ...
  editor: {
    ...
    top: 'Boven',
    bottom: 'Onder',
    shadowObjectTool: 'Schaduw object',
    fenceGarden: 'Omhein de tuin',
    autoFenceDesc: 'Zet automatisch hekken rondom je tuin',
    fenceNeedsZone: 'Teken eerst een zone',
    fenceConfirm: 'Er staan al hekken. Toch een omheining rondom de tuin toevoegen?',
    shadowCasterRectDesc: 'Teken een rechthoek — muur/schuur/burenpand',
    shadowCasterCircleLabel: 'Boom / Plant',
    shadowCasterCircleDesc: 'Teken een cirkel — boom, hoge haag',
    view: 'Bekijken →',
    tourBtn: 'Rondleiding',
    moreBtn: 'Meer',
    sunToggleTitle: 'Toon zon-perimeter',
    sunOn: 'Aan',
    sunOff: 'Uit',
    sunDisable: 'Zon-perimeter uit',
    sunEnable: 'Toon zon-perimeter',
    shadowObjectsHeader: 'Schaduw objecten',
