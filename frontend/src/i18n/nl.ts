...
export const nl: Translations = {
  ...
  settings: {
    ...
    dataTitle: 'Data',
    dataDescription: 'Download een kopie van je planten, kaarten, locaties en verzorgingsgeschiedenis.',
    downloadData: 'Download mijn data (JSON)',
    downloadCareLogCsv: 'Download verzorgingslog (CSV)',
