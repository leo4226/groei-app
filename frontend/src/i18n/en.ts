...
export const en: Translations = {
  ...
  settings: {
    ...
    calendarSubscriptionTitle: 'Personal calendar',
    calendarSubscriptionDescription: 'Mirror grouped Floreren care sessions in your personal calendar. Completion always stays in Floreren.',
    ...
    calendarSubscriptionContextDescription: 'Also include temporary heat and frost protection sessions.',
    calendarSubscriptionPrivacy: 'Hide plant and space names',
    calendarSubscriptionPrivacyDescription: 'Events show only the care action and a Floreren link.',
    ...
    calendarSubscriptionDownloadDescription: 'One-time snapshot. It does not refresh automatically.',
    calendarSubscriptionGoogle: 'Google Calendar',
    calendarSubscriptionOutlook: 'Outlook',
    calendarSubscriptionApple: 'Apple Calendar',
    calendarSubscriptionProviderHint: 'Use the private URL as a calendar subscription. Importing the downloaded file creates a one-time copy instead.',
    calendarSubscriptionRefreshHint: 'Google, Outlook and Apple control refresh timing; updates can take several hours.',
