...
export const en: Translations = {
  ...
  settings: {
    ...
    display: 'Display',
    groupOutdoorWarnings: 'Group garden care in Calendar',
    groupOutdoorWarningsDesc: 'Combine selected care sessions per garden for everyone in your household',
    calendarGroupingCareTypes: 'Care types to group',
    calendarGroupingMaps: 'Gardens to group',
