...
export const en: Translations = {
  ...
  settings: {
    ...
    careRhythmDescription: 'Bring recurring Water dates together on one or two preferred days, separately for indoor and outdoor spaces.',
    careRhythmProposed: 'Proposed',
    careRhythmSaved: 'Saved',
    careRhythmOrganize: 'Organize watering',
    careRhythmChange: 'Change rhythm',
    careRhythmSafety: 'Dates can move at most one day earlier and never later. Intervals and care history stay unchanged.',
    ...
    careRhythmPreviewTitle: 'Preview',
    careRhythmMovedCount: (count) => `${count} moved`,
    careRhythmUnchangedCount: (count) => `${count} unchanged`,
    careRhythmExceptionCount: (count) => `${count} ${count === 1 ? 'exception' : 'exceptions'}`,
    careRhythmGroupCount: (count) => `${count} ${count === 1 ? 'care group' : 'care groups'}`,
    careRhythmApply: 'Apply rhythm',
    careRhythmApplying: 'Applying…',
    careRhythmUndo: 'Undo',
    careRhythmUndoing: 'Undoing…',
    careRhythmApplied: (count) => `Rhythm applied to ${count} ${count === 1 ? 'schedule' : 'schedules'}`,
    ...
    careRhythmApplyError: 'Could not apply the rhythm. No dates were changed.',
    careRhythmStaleError: 'The schedules changed. Review the refreshed preview.',
    ...
    careRhythmReasonNoRoutine: 'No routine selected',
  ...
  calendar: {
    ...
    wateringRoundDescription: 'Select only the plants you actually watered. Their next dates will be calculated from today.',
