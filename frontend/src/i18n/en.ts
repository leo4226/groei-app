...
export const en: Translations = {
  ...
  editor: {
    ...
    top: 'Top',
    bottom: 'Bottom',
    shadowObjectTool: 'Shadow object',
    fenceGarden: 'Fence the garden',
    autoFenceDesc: 'Place fences around your garden automatically',
    fenceNeedsZone: 'Draw a zone first',
    fenceConfirm: 'Fences already exist. Add a perimeter fence anyway?',
    shadowCasterRectDesc: 'Draw a rectangle — wall/shed/neighbour',
    shadowCasterCircleLabel: 'Tree / Plant',
    shadowCasterCircleDesc: 'Draw a circle — tree, tall hedge',
    view: 'View →',
    tourBtn: 'Tour',
    moreBtn: 'More',
    sunToggleTitle: 'Show sun perimeter',
    sunOn: 'On',
    sunOff: 'Off',
    sunDisable: 'Disable sun perimeter',
    sunEnable: 'Show sun perimeter',
    shadowObjectsHeader: 'Shadow objects',
