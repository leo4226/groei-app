...
export const plants = {
  ...
  identifyPlantnet:  async (imageBlob: Blob)                       => { const f = new FormData(); f.append('image', imageBlob, 'plant.jpg'); return api<import('../types').IdentifyResponse>('POST', '/plants/identify?engine=plantnet', { form: f }) },
