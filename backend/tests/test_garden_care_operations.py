...
CREATE TABLE garden_care_operations (
    ...
    completed_at DATE, completed_by INTEGER, created_at TEXT, undone_at TEXT
);
...
async def test_complete_and_undo_garden_care_only_changes_outdoor_schedules(client, seeded_db, auth_header):
    ...
    await db.executescript("""
        ...
        INSERT INTO plants (id, name, household_id, map_id, is_active) VALUES
          (1, 'Rose', 1, 1, 1), (2, 'Basil', 1, 1, 1), (3, 'Monstera', 1, 2, 1);
    ...
    result = await client.post(
        ...
        json={'care_type': 'water', 'completed_at': '2026-07-10', 'user_id': 1},
        headers=auth_header,
    )
    ...
    assert [row['next_due'] for row in restored] == ['2026-07-01', '2026-07-02', '2026-07-03']
